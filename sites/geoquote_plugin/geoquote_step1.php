...
echo "<h3>GET A REAL-TIME QUOTE</h3>";
...
EOF;
			echo "<option value=\"D\"" . ($service_type == "D"?" selected":"").">High-Speed Fiber</option>";
...
<table class="geoquote_step1_button">
	<tr><td style="width: 45%;"></td><td><input type=submit img src="/sites/all/themes/coworker/images/btn-proceed.png"></td></tr>
</table>
