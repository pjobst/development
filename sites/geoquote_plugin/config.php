...
$version = 3; // Do not touch this!
$website = "jobst.us"; // Do not touch this!

$ReturnPath = "http://www.jobst.us/geoquote"; // Root ReturnPath to the 'return home' references on the last step of the Plug-in
$ReturnFrontPage = "geoquote.php"; // File name (step 1) within the ReturnPath directory

$AgentNumber = "120136"; // Your Agent Number (you can find this on your View Profile page of agent.telarus.com
